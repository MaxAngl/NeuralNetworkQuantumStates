...
logs_path = r"/users/eleves-b/2024/nathan.dupuy/NeuralNetworkQuantumStates/logs/Energies_taille_paire/pbc=True/Runs"

# Crée le dossier pour les logs s'il n'existe pas
os.makedirs(logs_path, exist_ok=True)

# Path vers le fichier .csv où on conserve le dictionnaire final
output_path = r"/users/eleves-b/2024/nathan.dupuy/NeuralNetworkQuantumStates/logs/Energies_taille_paire/pbc=True/Résultats.csv"
...
for L in L_list:    
    ...
    print(f"Données pour L={L} sauvegardées dans le CSV.")
