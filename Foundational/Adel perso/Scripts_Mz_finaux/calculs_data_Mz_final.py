...
# 1. CONFIGURATION
# ==========================================
RUN_DIR = r"/users/eleves-a/2024/adel.mana/Documents/NeuralNetworkQuantumStates/Foundational/logs/Trains_finaux_disordered_1D/run_L=100"
...
project_root = r"/users/eleves-a/2024/adel.mana/Documents/NeuralNetworkQuantumStates/Foundational"
...
for sigma in SIGMA_TEST_LIST:
    ...
    #if sigma == 0.0:
     #   base_noise = np.zeros((MAX_KEEP, L))
    #elif sigma == 0.05:
       # base_noise = rng.normal(loc=0.0, scale=0.05, size=(MAX_KEEP, L))
      #  base_noise_ref = base_noise.copy()
    #else:
     #   base_noise = base_noise_ref * (sigma / 0.05)
