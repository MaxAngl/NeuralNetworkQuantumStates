#!/bin/bash
# Lance les 6 tests ViT sans désordre (1 job par config, L=48)
# Usage:
#   bash Foundational/launch_1D_sans_desordre_test_vit.sh          # toutes les configs (0-5)
#   bash Foundational/launch_1D_sans_desordre_test_vit.sh 0 2 4    # seulement ces configs
