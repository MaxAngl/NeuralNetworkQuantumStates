...
- 70 iters per epoch batch
- 420 total iters for both methods

Saves to: graphs/epoch_comparison_v4/
"""
...
out_dir = os.path.join(project_root, "graphs", "epoch_comparison_v4")
...
print("=" * 60)
print("  Epoch Training Comparison v4 (MC eval, h0>=0.1)")
...
pdf_path = os.path.join(out_dir, "epoch_comparison_v4.pdf")
png_path = os.path.join(out_dir, "epoch_comparison_v4.png")
